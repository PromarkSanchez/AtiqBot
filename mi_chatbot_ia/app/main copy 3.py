...
from app.core.app_state import initialize_global_models # <-- Cambia el nombre
...
# ==========================================================
# ======>     LIFESPAN MANAGER (A PRUEBA DE BALAS)     <======
# ==========================================================
@asynccontextmanager
async def lifespan(app: FastAPI):
    print(f"\nINFO:     [STARTUP] FastAPI App '{app.title}' v{app.version} iniciando...")
    try:
        # ¡LA CORRECCIÓN N°2! La llamada es SÍNCRONA, sin 'await'.
        initialize_global_models()
        print("INFO:     [STARTUP] ¡Todos los modelos y conexiones se han inicializado con éxito!")
        yield
    except Exception as e:
        print("--- !!! ARRANQUE FALLIDO - ERROR CRÍTICO IRRECUPERABLE !!! ---")
        traceback.print_exc()
        print("--- LA APLICACIÓN NO PUEDE ARRANCAR EN UN ESTADO INCONSISTENTE. APAGANDO. ---")
    finally:
        print("\nINFO:     [SHUTDOWN] Servidor apagándose.")
