 ...
 */
import type { DatabaseConnectionUpdateExtraParamsAnyOf } from './databaseConnectionUpdateExtraParamsAnyOf';

export type DatabaseConnectionUpdateExtraParams = DatabaseConnectionUpdateExtraParamsAnyOf | null;
