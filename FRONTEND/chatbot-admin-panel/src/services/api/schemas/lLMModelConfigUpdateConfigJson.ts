 ...
 */
import type { LLMModelConfigUpdateConfigJsonAnyOf } from './lLMModelConfigUpdateConfigJsonAnyOf';

export type LLMModelConfigUpdateConfigJson = LLMModelConfigUpdateConfigJsonAnyOf | null;
