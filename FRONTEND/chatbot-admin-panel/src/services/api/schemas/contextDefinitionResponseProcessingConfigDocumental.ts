 ...
 */
import type { DocumentalProcessingConfigSchema } from './documentalProcessingConfigSchema';

export type ContextDefinitionResponseProcessingConfigDocumental = DocumentalProcessingConfigSchema | null;
