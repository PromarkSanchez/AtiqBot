 ...
 */
import type { LLMModelConfigCreateConfigJsonAnyOf } from './lLMModelConfigCreateConfigJsonAnyOf';

export type LLMModelConfigCreateConfigJson = LLMModelConfigCreateConfigJsonAnyOf | null;
