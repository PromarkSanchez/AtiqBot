 ...
 */
import type { SqlTableAccessRuleSchemaColumnPolicy } from './sqlTableAccessRuleSchemaColumnPolicy';

export interface SqlTableAccessRuleSchema {
  /** @minLength 1 */
  table_name: string;
  column_policy?: SqlTableAccessRuleSchemaColumnPolicy;
}
