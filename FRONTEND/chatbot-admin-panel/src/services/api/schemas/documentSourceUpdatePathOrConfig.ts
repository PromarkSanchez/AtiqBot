 ...
 */
import type { DocumentSourceUpdatePathOrConfigAnyOf } from './documentSourceUpdatePathOrConfigAnyOf';

export type DocumentSourceUpdatePathOrConfig = DocumentSourceUpdatePathOrConfigAnyOf | string | null;
