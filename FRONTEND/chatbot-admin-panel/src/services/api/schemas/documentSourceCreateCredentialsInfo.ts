 ...
 */
import type { DocumentSourceCreateCredentialsInfoAnyOf } from './documentSourceCreateCredentialsInfoAnyOf';

export type DocumentSourceCreateCredentialsInfo = DocumentSourceCreateCredentialsInfoAnyOf | null;
