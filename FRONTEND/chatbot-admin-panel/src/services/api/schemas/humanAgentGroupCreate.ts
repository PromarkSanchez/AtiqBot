 ...
 */
import type { HumanAgentGroupCreateDescription } from './humanAgentGroupCreateDescription';

export interface HumanAgentGroupCreate {
  /**
   * @minLength 3
   * @maxLength 100
   */
  name: string;
  description?: HumanAgentGroupCreateDescription;
  is_active?: boolean;
}
