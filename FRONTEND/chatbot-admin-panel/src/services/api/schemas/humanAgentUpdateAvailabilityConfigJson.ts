 ...
 */
import type { HumanAgentUpdateAvailabilityConfigJsonAnyOf } from './humanAgentUpdateAvailabilityConfigJsonAnyOf';

export type HumanAgentUpdateAvailabilityConfigJson = HumanAgentUpdateAvailabilityConfigJsonAnyOf | null;
