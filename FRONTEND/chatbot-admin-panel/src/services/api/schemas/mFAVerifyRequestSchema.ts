 ...
 */
import type { MFAVerifyRequestSchemaPreMfaToken } from './mFAVerifyRequestSchemaPreMfaToken';

export interface MFAVerifyRequestSchema {
  username_ad: string;
  mfa_code: string;
  pre_mfa_token?: MFAVerifyRequestSchemaPreMfaToken;
}
