 ...
 */
import type { VirtualAgentProfileResponse } from './virtualAgentProfileResponse';

export type ContextDefinitionResponseVirtualAgentProfile = VirtualAgentProfileResponse | null;
