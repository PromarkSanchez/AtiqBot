 ...
 */
import type { ChatResponseMetadataDetailsAnyOf } from './chatResponseMetadataDetailsAnyOf';

export type ChatResponseMetadataDetails = ChatResponseMetadataDetailsAnyOf | null;
