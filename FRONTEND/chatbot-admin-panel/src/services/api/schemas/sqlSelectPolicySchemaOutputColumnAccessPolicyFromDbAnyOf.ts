 ...
 */
import type { SqlColumnAccessPolicySchema } from './sqlColumnAccessPolicySchema';

export type SqlSelectPolicySchemaOutputColumnAccessPolicyFromDbAnyOf = {[key: string]: SqlColumnAccessPolicySchema};
