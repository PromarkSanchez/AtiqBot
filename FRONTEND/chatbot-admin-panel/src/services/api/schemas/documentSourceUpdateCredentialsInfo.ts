 ...
 */
import type { DocumentSourceUpdateCredentialsInfoAnyOf } from './documentSourceUpdateCredentialsInfoAnyOf';

export type DocumentSourceUpdateCredentialsInfo = DocumentSourceUpdateCredentialsInfoAnyOf | null;
